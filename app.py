...
def landingwhoareyou():
    ...
    try:
        ...
        print("whoops from landingwhoareyou")
        html = render_template("error.html")
        response = make_response(html)
        return response
...
def studentsearch():
    ...
    # old code
        ...
        print("whoops from studentsearch")
        html = render_template("error.html")
        response = make_response(html)
        return response
...
scheduler.add_job(func=calculate_over, trigger="interval", minutes=30)
scheduler.add_job(func=calculate_div, trigger="interval", minutes=30)
scheduler.add_job(func=calculate_inc, trigger="interval", minutes=30)
scheduler.add_job(func=calculate_time, trigger="interval", minutes=30)
scheduler.add_job(func=calculate_work, trigger="interval", minutes=30)
scheduler.add_job(func=calculate_exp, trigger="interval", minutes=30)
